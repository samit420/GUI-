...
menu_category_dict = {"Tea & Coffee":" 1 Tea & Coffee.txt","Beverages":"2 Beverages.txt","Fast Food":"3 Fast Food.txt","Nepali":"4 Nepali.txt", "Starters":"5 Starters.txt", "Main Course":"6 Main Course.txt","Dessert":"7 7 Dessert.txt"}
order_dict = {}
...
def load_menu():
    ...
    for file in menu_file_list:
        ...
        while True:
         ...
         #menu_tabel.insert('',END,values=["Ice cream","150"])
...
root.title("Welcome to Regan Hotel, Bharatpur-11, Chitwan")
...
title_label = Label(title_frame, text="Regan Hotel,\n Bharatpur-11,Chitwan",
